...
class COCOeval:
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            # pr_array = precisions[0, :, 0, :, 2]
            with open('/home/hello/code/mmyolo/eval/eval_rtmd_s_6400x6400_l_trt_fp16.pkl', 'wb') as tf:
                pickle.dump(self.eval, tf)
            # print('IOU=0.5, pr: ', pr_array1)
            return stats
        def _summarizeKps():
            stats = np.zeros((10,))
...
class Params:
    ...
    def setDetParams(self):
        ...
        self.areaRng = [[0 ** 2, 1e5 ** 2], [0 ** 2, 96 ** 2], [96 ** 2, 288 ** 2], [288 ** 2, 1e5 ** 2]]
